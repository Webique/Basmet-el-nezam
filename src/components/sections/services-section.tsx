  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-5">
        <ExportedImage
          src="/images/shapes-from-the-pdf/برزنتيشن بصمة النظام (1).pdf-image-002 copy.png"
          alt=""
          fill
      ...
      <m.div
        ...
        className="bg-primary/5 absolute left-0 top-1/4 h-96 w-96 rounded-full blur-3xl"
      />
      <m.div
        animate={{ scale: [1, 1.2, 1], opacity: [0.05, 0.1, 0.05] }}
        transition={{ duration: 4, delay: 1, repeat: Infinity }}
        className="absolute bottom-1/4 right-0 h-96 w-96 rounded-full bg-primary/5 blur-3xl"
      />
            ...
            return (
              ...
              >
                ...
                <m.div
                  ...
                  className="from-primary to-primary/50 absolute bottom-0 left-0 h-1 bg-linear-to-r"
                />
